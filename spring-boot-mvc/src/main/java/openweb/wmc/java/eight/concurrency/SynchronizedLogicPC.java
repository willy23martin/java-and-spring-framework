...
public class SynchronizedLogicPC {
	...
	public SynchronizedLogicPC(List<String> contactPhoneNumbersSet) {
	...
	public synchronized String takeContact(int i) {
		while(this.contactPhoneNumbersSet.isEmpty()) {
			try {
				wait();
			} catch(Exception e) {
				e.printStackTrace();
		...
		String contact = this.contactPhoneNumbersSet.get(i);
		notifyAll();
		return contact;
	}
	
	public synchronized void putContact(String contact) {
		while(!this.contactPhoneNumbersSet.isEmpty()) {
			try {
				wait();
			} catch(Exception e) {
		...
		this.contactPhoneNumbersSet.add(contact);
		notifyAll();
	}
	...
	public List<String> getContactPhoneNumbersSet() {
		return contactPhoneNumbersSet;
	}

	public void setContactPhoneNumbersSet(List<String> contactPhoneNumbersSet) {
		this.contactPhoneNumbersSet = contactPhoneNumbersSet;
	}
