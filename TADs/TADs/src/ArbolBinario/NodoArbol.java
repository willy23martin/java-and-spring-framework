...
public class NodoArbol<T> implements Comparable<NodoArbol<T>> {
	...
	public boolean equals(Object obj) {
		if (obj instanceof NodoArbol) {
			if (((NodoArbol) obj).getElemento() instanceof Double
					|| ((NodoArbol) obj).getElemento() instanceof Integer) {
				return this.getElemento() == ((NodoArbol) obj).getElemento();
			} else {
				return ((NodoArbol<T>) obj).toString().equalsIgnoreCase(
						this.toString());
			}
		} else {
			return false;
